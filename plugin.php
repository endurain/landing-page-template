<?php
/**
 * Plugin Name: C1 Partners PPC Landing Page
 * Plugin URI: https://c1partners.com
...
class PageTemplater {
	...
	private function __construct() {
		...
		$this->templates = array(
			'ppclanding-template.php' => 'PPC Landing Template',
		);
	 ...
	 * into thinking the template file exists where it doens't really exist. Take that, WordPress. 
	 */
